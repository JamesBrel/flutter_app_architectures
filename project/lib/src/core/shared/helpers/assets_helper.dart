...
import '../../configs/initial_config/injector.dart';
import '../../services/supabase/supabase_service.dart';
import '../constants/assets_const.dart';
import '../constants/envs_const.dart';

class AssetsHelper {
  static var _supabaseService = getIt<SupabaseService>();
  ...
  static Widget getImage(String path, {Widget Function(File file)? builder}) {
